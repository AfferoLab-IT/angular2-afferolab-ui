                  ...
                  <tr *ngFor="let item of items">
                    <td *ngFor="let value of item.columns">                                               
                     ...
                     <td *ngIf="!provider.readOnly">
                        <a *ngIf="provider.actionEdit && provider.actionEdit.canShow() && (item.showEdit != null ? item.showEdit : true)" [routerLink]="[provider.path, item.id]"><i class="material-icons action-button">mode_edit</i></a>
